...
| <a name="input_email_from_field"></a> [email\_from\_field](#input\_email\_from\_field) | A valid sender for the SMTP server to be set in the 'From' field of outgoing emails | `string` | n/a | yes |
